...
TEST(VirtualOffsetAddress, EmptyKeyReturnsZero) { EXPECT_EQ(ml::VirtualOffsetAddress::compute({}), 0u); }
...
TEST(VirtualOffsetAddress, CapacityFor0Is0) { EXPECT_EQ(ml::VirtualOffsetAddress::capacity_for(0), 0u); }
