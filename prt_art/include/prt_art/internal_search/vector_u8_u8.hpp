#pragma once
// Vector<u8,u8> internal search — Density 50-75% (REV 6 §5.17)
//
// Sortiertes Vector von (uint8_t-Diskriminator, child_index)-Paaren.
// Lookup via Binary Search (oder SIMD-Linear-Scan). Speicher-effizient bei
// mittlerer Density (kein Slot-Overhead wie Array<256>).
...
public:
    ...
    static constexpr std::size_t kCapacity = 256;   // u8-Diskriminatoren
