#pragma once
// Array<256> internal search - Density bis 25% (REV 6 S5.17)
//
...
public:
    ...
    void insert(std::uint8_t discriminator, std::uint64_t child_index) noexcept { slots_[discriminator] = child_index; }
    ...
    void erase(std::uint8_t discriminator) noexcept { slots_[discriminator] = kEmpty; }
