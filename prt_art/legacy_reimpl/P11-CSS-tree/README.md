# P11-CSS-tree — Re-Implementation-Skelett

**Paper:** Cache-Sensitive Search Trees
**Autor/Jahr:** Rao/Ross 1999
**Kernkonzept:** Pointer-frei, Cache-Line-grosse Knoten, Index-Arithmetik statt Pointers
...
1. **Pseudocode-Extraktion** aus Originalpaper (siehe `Forschungsarbeiten/Cache-Sensitive Memory Layout for Binary Trees.pdf`)
...
├── include/
│   └── css_node_page.hpp             (Concept-Anbindung)
├── src/
│   └── css_node_page.cpp             (Implementation)
└── tests/
    └── css_node_page_test.cpp        (Google-Tests)
```
