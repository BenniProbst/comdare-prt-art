# P14-Samuel — Re-Implementation-Skelett

**Paper:** Making CSB+-Trees Processor Conscious
**Autor/Jahr:** Samuel/Pedersen/Bonnet 2005
**Kernkonzept:** Configuration Table indexed by (key size, value size, update ratio)
...
1. **Pseudocode-Extraktion** aus Originalpaper (siehe `Forschungsarbeiten/Making CSB+-Trees Processor Conscious.pdf`)
...
├── include/
│   └── config_table_bplus_page.hpp             (Concept-Anbindung)
├── src/
│   └── config_table_bplus_page.cpp             (Implementation)
└── tests/
    └── config_table_bplus_page_test.cpp        (Google-Tests)
```
