# P17-Bender-CacheOblivious — Re-Implementation-Skelett

**Paper:** Cache-Oblivious B-Trees
**Autor/Jahr:** Bender/Demaine/Farach-Colton 2005
**Kernkonzept:** Performance ohne Kenntnis konkreter Cache-Parameter (Gegenpol PRT-ART)
...
1. **Pseudocode-Extraktion** aus Originalpaper (siehe `Forschungsarbeiten/CACHE-OBLIVIOUS B-TREES.pdf`)
...
├── include/
│   └── cache_oblivious_layout.hpp             (Concept-Anbindung)
├── src/
│   └── cache_oblivious_layout.cpp             (Implementation)
└── tests/
    └── cache_oblivious_layout_test.cpp        (Google-Tests)
```
