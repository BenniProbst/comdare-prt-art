# P27-Zhang-ASPLOS-Hierarchical — Re-Implementation-Skelett

**Paper:** Hierarchical Prefetching
**Autor/Jahr:** T. Zhang et al. ASPLOS 2025
**Kernkonzept:** Bundle-Prefetching mit Software/Hardware-Hybrid-Mechanik (Konzept-Quelle, gem5-Hardware-Fork)
...
1. **Pseudocode-Extraktion** aus Originalpaper (siehe `Forschungsarbeiten/ZhangEtalASPLOS2025HierarchicalPrefetching.pdf`)
...
├── include/
│   └── hierarchical_bundle_prefetch.hpp             (Concept-Anbindung)
├── src/
│   └── hierarchical_bundle_prefetch.cpp             (Implementation)
└── tests/
    └── hierarchical_bundle_prefetch_test.cpp        (Google-Tests)
```
