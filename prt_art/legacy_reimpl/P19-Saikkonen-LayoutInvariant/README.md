# P19-Saikkonen-LayoutInvariant — Re-Implementation-Skelett

**Paper:** Layout Invariants with Constant-Time Updates
**Autor/Jahr:** Saikkonen/Soisalon-Soininen 2016
**Kernkonzept:** Layout-Invariante mit konstanten Update-Operationen
...
1. **Pseudocode-Extraktion** aus Originalpaper (siehe `Forschungsarbeiten/Efficient Tree Layout in a Multilevel Memory Hierarchy.pdf`)
...
├── include/
│   └── layout_invariant.hpp             (Concept-Anbindung)
├── src/
│   └── layout_invariant.cpp             (Implementation)
└── tests/
    └── layout_invariant_test.cpp        (Google-Tests)
```
