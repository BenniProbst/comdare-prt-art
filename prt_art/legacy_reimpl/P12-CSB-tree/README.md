# P12-CSB-tree — Re-Implementation-Skelett

**Paper:** Making B+-Trees Cache Conscious in Main Memory
**Autor/Jahr:** Rao/Ross 2000
**Kernkonzept:** Sibling-Cluster, Parent haelt 1 Pointer + Offsets
...
1. **Pseudocode-Extraktion** aus Originalpaper (siehe `Forschungsarbeiten/Making B+-Trees Cache Conscious in Main Memory.pdf`)
...
├── include/
│   └── csb_node_group_page.hpp             (Concept-Anbindung)
├── src/
│   └── csb_node_group_page.cpp             (Implementation)
└── tests/
    └── csb_node_group_page_test.cpp        (Google-Tests)
```
