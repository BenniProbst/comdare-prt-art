# P23-Khan-AdaptivePrefetch — Re-Implementation-Skelett

**Paper:** Data Cache Prefetching With Dynamic Adaptation
**Autor/Jahr:** Khan 2010
**Kernkonzept:** Code-Specializer adaptiert Prefetch-Distance zur Laufzeit
...
1. **Pseudocode-Extraktion** aus Originalpaper (siehe `Forschungsarbeiten/Data Cache Prefetching With DynamicAdaptation.pdf`)
...
├── include/
│   └── adaptive_prefetch_distance.hpp             (Concept-Anbindung)
├── src/
│   └── adaptive_prefetch_distance.cpp             (Implementation)
└── tests/
    └── adaptive_prefetch_distance_test.cpp        (Google-Tests)
```
